...
<div class="wp-block-group" style="margin-top:4rem">
	<!-- wp:group {"align":"wide","style":{"spacing":{"margin":{"bottom":"15px"}}},"layout":{"type":"constrained","contentSize":"","justifyContent":"left"}} -->
	...
	<div class="wp-block-columns alignwide">
		<!-- wp:column {"width":"512px","style":{"typography":{"lineHeight":"1.5","textTransform":"uppercase","fontSize":"10px"},"color":{"text":"#ffffff"},"elements":{"link":{"color":{"text":"#ffffff"}}}}} -->
		...
		<div class="wp-block-column">
			<!-- wp:post-title {"level":1,"style":{"color":{"text":"#282828"},"elements":{"link":{"color":{"text":"#282828"}}},"spacing":{"margin":{"top":"0px"}},"typography":{"fontSize":"2.2rem"}},"__woocommerceNamespace":"woocommerce/product-query/product-title"} /-->
