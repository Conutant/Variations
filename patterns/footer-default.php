...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:navigation {"ref":4,"textColor":"contrast","overlayMenu":"never","layout":{"type":"flex","justifyContent":"left"}} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:paragraph {"align":"right","fontSize":"xxx-small"} -->
<p class="has-text-align-right has-xxx-small-font-size"><?php printf(
