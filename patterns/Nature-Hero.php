...
<div class="wp-block-group alignwide has-base-color has-text-color" style="padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:site-title {"level":0,"textColor":"contrast"} /-->

<!-- wp:navigation {"ref":4,"textColor":"contrast","layout":{"type":"flex","setCascadingProperties":true,"justifyContent":"right"}} /--></div>
<!-- /wp:group -->
