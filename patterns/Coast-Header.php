...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%"><!-- wp:heading {"style":{"color":{"text":"#fffffd"},"elements":{"link":{"color":{"text":"#fffffd"},":hover":{"color":{"text":"#fffffd"}}}},"typography":{"fontSize":"2rem","lineHeight":"1.2","textDecoration":"none"}}} -->
<h2 class="wp-block-heading has-text-color has-link-color" style="color:#fffffd;font-size:2rem;line-height:1.2;text-decoration:none"><a href="/">Pilgrimage</a></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
