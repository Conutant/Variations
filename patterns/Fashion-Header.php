...
<div class="wp-block-button has-custom-font-size is-style-outline" style="font-size:1.1rem;font-style:normal;font-weight:600;line-height:1.5;text-transform:none"><a class="wp-block-button__link has-text-color wp-element-button" style="border-style:none;border-width:0px;border-radius:0px;color:#1f1f1f;padding-top:0.2rem;padding-right:1rem;padding-bottom:0.2rem;padding-left:1rem"><img class="wp-image-577" style="width: 28px;" src="http://tyler.local/wp-content/themes/variations-child/assets/images/fashion/fashion-shopping-bag.svg" alt=""></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
