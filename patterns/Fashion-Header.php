...
<div class="wp-block-group" style="line-height:0"><!-- wp:image {"id":576,"width":"180px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/fashion/fashion-logo.png" alt="" class="wp-image-576" style="width:180px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
