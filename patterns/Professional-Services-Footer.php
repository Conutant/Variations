...
<p class="has-text-color" style="color:#fffffd;margin-top:1.7rem;margin-bottom:2.77rem;font-size:1.25rem;font-style:normal;font-weight:400;line-height:1.5"><?php printf( esc_html__( '%s', 'variations' ), __( 'This is a great space to write long text about your company and your services.', 'variations' ) ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fffffd"}}},"typography":{"textDecoration":"none","fontSize":"1.25rem","fontStyle":"normal","fontWeight":"400","lineHeight":"1.8"},"spacing":{"margin":{"top":"1.56rem"}}}} -->
<p class="has-link-color" style="margin-top:1.56rem;font-size:1.25rem;font-style:normal;font-weight:400;line-height:1.8;text-decoration:none"><a href="#"><?php printf( esc_html__( '%s', 'variations' ), __( 'About', 'variations' ) ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fffffd"}}},"typography":{"fontSize":"1.25rem","fontStyle":"normal","fontWeight":"400","lineHeight":"1.8"},"spacing":{"margin":{"top":"1.25rem"}}}} -->
<p class="has-link-color" style="margin-top:1.25rem;font-size:1.25rem;font-style:normal;font-weight:400;line-height:1.8"><a href="#"><?php printf( esc_html__( '%s', 'variations' ), __( 'News', 'variations' ) ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fffffd"}}},"typography":{"fontSize":"1.25rem","fontStyle":"normal","fontWeight":"400","lineHeight":"1.8"},"spacing":{"margin":{"top":"1.25rem"}}}} -->
<p class="has-link-color" style="margin-top:1.25rem;font-size:1.25rem;font-style:normal;font-weight:400;line-height:1.8"><a href="#"><?php printf( esc_html__( '%s', 'variations' ), __( 'Read Me', 'variations' ) ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
