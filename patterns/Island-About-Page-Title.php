...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"400","lineHeight":"1","fontSize":"3.71rem"},"spacing":{"margin":{"bottom":"1.01rem","top":"0rem"}},"color":{"text":"#07277c"}},"extendedSettings":{"prompt":""}} -->
<h2 class="wp-block-heading has-text-align-center has-text-color" style="color:#07277c;margin-top:0rem;margin-bottom:1.01rem;font-size:3.71rem;font-style:normal;font-weight:400;line-height:1"><?php printf( esc_html__( '%s', 'variations' ), __( 'About The Island', 'variations' ) ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->