...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:30%"><!-- wp:site-title {"level":2,"style":{"color":{"text":"#2b3c2c"},"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"700"}}} /--></div>
<!-- /wp:column -->
...
<div class="wp-block-group"><!-- wp:navigation {"customTextColor":"#2b3c2c","layout":{"type":"flex","justifyContent":"right"},"style":{"typography":{"fontSize":"18px"}},"fontFamily":"poppins"} /-->
