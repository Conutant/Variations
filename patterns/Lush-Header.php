...
<div class="wp-block-group"><!-- wp:navigation {"ref":453,"customTextColor":"#2b3c2c","icon":"menu","layout":{"type":"flex","justifyContent":"center"},"style":{"typography":{"fontSize":"18px"}},"fontFamily":"poppins"} /-->
