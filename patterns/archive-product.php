...
<!-- wp:group {"style":{"spacing":{"margin":{"top":"4rem"}}},"layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group" style="margin-top:4rem">
	<!-- wp:woocommerce/breadcrumbs {"style":{"color":{"text":"#686868"},"elements":{"link":{"color":{"text":"#282828"}}}}} /-->
	...
	<div class="wp-block-query alignwide">
		<!-- wp:post-template {"className":"products-block-post-template","layout":{"type":"grid","columnCount":3},"fontSize":"small","__woocommerceNamespace":"woocommerce/product-query/product-template"} -->
		<!-- wp:group {"style":{"typography":{"fontSize":"0.75em"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group" style="font-size:0.75em"><!-- wp:woocommerce/product-image {"saleBadgeAlign":"left","isDescendentOfQueryLoop":true,"height":"385px"} /--></div>
		<!-- /wp:group -->
		<!-- wp:group {"style":{"spacing":{"blockGap":"0rem"},"dimensions":{"minHeight":"10rem"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"space-between"}} -->
		...
		<!-- wp:woocommerce/product-button {"textAlign":"center","isDescendentOfQueryLoop":true,"fontSize":"small","style":{"spacing":{"margin":{"bottom":"2rem"}}}} /--></div>
		<!-- /wp:group -->
		<!-- /wp:post-template -->
