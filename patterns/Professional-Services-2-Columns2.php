<?php
/**
 * Title: Professional Services 2 Columns 2
 * Slug: variations/professional-services-2-columns2
...
<div class="wp-block-group alignfull has-text-color" style="color:#3e3e3e;margin-top:0px;padding-top:8.01rem;padding-right:1rem;padding-bottom:8.01rem;padding-left:1rem;font-size:1.13rem;font-style:normal;font-weight:400;line-height:1.4"><!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"3rem","left":"3.5rem"}}}} -->
<div class="wp-block-columns"><!-- wp:column {"width":"53%","layout":{"type":"default"}} -->
<div class="wp-block-column" style="flex-basis:53%"><!-- wp:image {"id":528,"width":"588px","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/team/professional-services-s6.jpg" alt="" class="wp-image-528" style="width:588px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
