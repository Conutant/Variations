...
<div class="wp-block-group alignfull" style="min-height:0px;margin-top:0px;margin-bottom:0px;padding-top:1rem;padding-right:1rem;padding-bottom:1rem;padding-left:1rem"><!-- wp:columns {"style":{"color":{"text":"#141414"},"spacing":{"padding":{"top":"4rem","bottom":"4rem","left":"0px","right":"0px"},"margin":{"top":"0px","bottom":"0px"},"blockGap":{"top":"1rem","left":"1rem"}}},"fontFamily":"inter"} -->
<div class="wp-block-columns has-text-color has-inter-font-family" style="color:#141414;margin-top:0px;margin-bottom:0px;padding-top:4rem;padding-right:0px;padding-bottom:4rem;padding-left:0px"><!-- wp:column {"width":"30%","style":{"spacing":{"padding":{"right":"1rem","top":"2rem","bottom":"2rem","left":"0px"},"blockGap":"1rem"}}} -->
<div class="wp-block-column" style="padding-top:2rem;padding-right:1rem;padding-bottom:2rem;padding-left:0px;flex-basis:30%"><!-- wp:heading {"style":{"typography":{"fontSize":"2.3rem"}}} -->
...
<!-- wp:column {"width":"40%","style":{"spacing":{"padding":{"top":"2rem","bottom":"2rem","left":"0px","right":"0px"},"blockGap":"0px"}}} -->
<div class="wp-block-column" style="padding-top:2rem;padding-right:0px;padding-bottom:2rem;padding-left:0px;flex-basis:40%"><!-- wp:image {"align":"center","id":144,"scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image aligncenter size-full"><img src="https://staging.tyler.com/wp-content/uploads/2023/10/Consulting-second-section-1.jpg" alt="" class="wp-image-144" style="object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
