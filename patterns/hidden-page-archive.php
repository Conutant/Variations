...
<div class="wp-block-group alignwide" style="min-height:50vh;padding-top:50px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:query-title {"type":"archive","showPrefix":false,"style":{"typography":{"fontSize":"2.8rem"},"color":{"text":"#ffffff"},"elements":{"link":{"color":{"text":"#ffffff"}}},"spacing":{"margin":{"top":"40px"}}},"fontFamily":"hedvig-letters-serif-regular"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"constrained","contentSize":"1140px"}} -->
<div class="wp-block-group" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:columns {"isStackedOnMobile":false,"align":"full"} -->
