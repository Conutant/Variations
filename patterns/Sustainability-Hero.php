...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"5.9rem","lineHeight":"1.1"},"spacing":{"margin":{"bottom":"1.1rem"}},"color":{"text":"#fffffd"}}} -->
<h2 class="wp-block-heading has-text-align-left has-text-color" style="color:#fffffd;margin-bottom:1.1rem;font-size:5.9rem;font-style:normal;font-weight:400;line-height:1.1"><?php printf( esc_html__( '%s', 'variations' ), __( 'Dare To Be Innovative<br>Care About Sustainability', 'variations' ) ); ?></h2>
<!-- /wp:heading -->
