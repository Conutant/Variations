...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:navigation {"ref":48,"customTextColor":"#fffffd","overlayMenu":"never","layout":{"type":"flex","justifyContent":"center"}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->