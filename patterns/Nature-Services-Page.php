...
<div class="wp-block-group" style="padding-top:4.51rem;padding-right:2.71rem;padding-bottom:4.51rem;padding-left:0"><!-- wp:heading {"textAlign":"left","fontSize":"x-large"} -->
...
<div class="wp-block-buttons" style="margin-top:2.01rem;margin-bottom:0"><!-- wp:button {"textColor":"base","style":{"spacing":{"padding":{"left":"50px","right":"50px","top":"9px","bottom":"9px"}},"color":{"background":"#74a84a"}},"className":"is-style-fill","fontSize":"medium"} -->
