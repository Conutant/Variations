...
<h1 class="wp-block-heading has-text-color" style="color:#345c01;font-size:6rem"><?php printf( esc_html__( '%s', 'variations' ), __( 'Services', 'variations' ) ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'variations' ), __( 'Web Design', 'variations' ) ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-buttons" style="margin-top:2.01rem;margin-bottom:0"><!-- wp:button {"style":{"spacing":{"padding":{"left":"50px","right":"50px","top":"9px","bottom":"9px"}},"color":{"background":"#74a84a","text":"#fffffd"},"typography":{"fontSize":"1.13rem"}},"className":"is-style-fill"} -->
<div class="wp-block-button has-custom-font-size is-style-fill" style="font-size:1.13rem"><a class="wp-block-button__link has-text-color has-background wp-element-button" style="color:#fffffd;background-color:#74a84a;padding-top:9px;padding-right:50px;padding-bottom:9px;padding-left:50px"><?php printf( esc_html__( '%s', 'variations' ), __( 'EXPLORE', 'variations' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
...
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'variations' ), __( 'Graphic Design', 'variations' ) ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile" style="margin-right:0;margin-left:0;padding-right:0;padding-left:0"><div class="wp-block-media-text__content"><!-- wp:group {"style":{"spacing":{"padding":{"right":"2.71rem","left":"0","top":"4.51rem","bottom":"4.51rem"},"blockGap":"0.6rem"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:4.51rem;padding-right:2.71rem;padding-bottom:4.51rem;padding-left:0"><!-- wp:heading {"textAlign":"left","style":{"typography":{"fontSize":"2.26rem"}}} -->
<h2 class="wp-block-heading has-text-align-left" style="font-size:2.26rem"><?php printf( esc_html__( '%s', 'variations' ), __( 'Content Writing', 'variations' ) ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"spacing":{"padding":{"left":"50px","right":"50px","top":"9px","bottom":"9px"}},"color":{"background":"#74a84a","text":"#fffffd"},"typography":{"fontSize":"1.13rem"}},"className":"is-style-fill"} -->
<div class="wp-block-button has-custom-font-size is-style-fill" style="font-size:1.13rem"><a class="wp-block-button__link has-text-color has-background wp-element-button" style="color:#fffffd;background-color:#74a84a;padding-top:9px;padding-right:50px;padding-bottom:9px;padding-left:50px"><?php printf( esc_html__( '%s', 'variations' ), __( 'EXPLORE', 'variations' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
