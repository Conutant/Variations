...
<div class="wp-block-group has-text-color" style="color:#1f1f1f;margin-top:0;margin-bottom:0;padding-right:1rem;padding-left:1rem;font-size:2.6rem;font-style:normal;font-weight:400;line-height:1.5"><!-- wp:columns {"style":{"spacing":{"padding":{"top":"2rem","bottom":"2rem","left":"3.25rem","right":"3.25rem"},"blockGap":{"top":"1rem","left":"1.62rem"}}}} -->
<div class="wp-block-columns" style="padding-top:2rem;padding-right:3.25rem;padding-bottom:2rem;padding-left:3.25rem"><!-- wp:column {"verticalAlignment":"center","width":"85%","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"0px"}}}} -->
...
<div class="wp-block-group"><!-- wp:site-logo {"width":74,"shouldSyncIcon":true,"style":{"layout":{"selfStretch":"fit","flexSize":null}}} /-->

<!-- wp:navigation {"ref":227,"customTextColor":"#1f1f1f","layout":{"type":"flex","justifyContent":"center"},"style":{"typography":{"fontSize":"1.1rem","fontStyle":"normal","fontWeight":"400","lineHeight":"1.8"},"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"blockGap":"1.5rem"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"170px","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"0px","right":"0px"}}},"layout":{"type":"constrained","justifyContent":"center","contentSize":""}} -->
<div class="wp-block-column" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;flex-basis:170px"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"right","flexWrap":"wrap","orientation":"horizontal"},"style":{"layout":{"selfStretch":"fit","flexSize":null},"spacing":{"margin":{"top":"0.2rem"}}}} -->
